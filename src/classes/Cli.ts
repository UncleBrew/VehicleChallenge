...
class Cli {
  ...
  createCar(): void {
    inquirer
      ...
      .then((answers) => {
        const car = new Car(
          // TODO: The generateVin method is static and should be called using 
          //the class name Cli
          Cli.generateVin(),
          answers.color,
          answers.make,
  ...
  createTruck(): void {
    inquirer
      ...
      .then((answers) => {
        // TODO: Use the answers object to pass the required properties 
        // to the Truck constructor
  ...
  performActions(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        // TODO: add statements to perform the tow action only if
        // the selected vehicle is a truck. Call the findVehicleToTow
        // method to find a vehicle to tow and pass the selected
        // truck as an argument. After calling the findVehicleToTow method,
          ...
          for (let i = 0; i < this.vehicles.length; i++) {
            if (this.vehicles[i].vin === this.selectedVehicleVin) {
              if (this.vehicles[i] instanceof Truck) {
                this.findVehicleToTow(this.vehicles[i] as Truck);  // Ensure it's casted as Truck
                console.log('Selected vehicle is a truck');
                return;
              } else {
                console.log('Selected vehicle is not a truck and cannot perform towing.');
